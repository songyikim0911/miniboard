...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.html">Start Bootstrap</a>  <!--여기야!!!!-->
    <!-- Sidebar Toggle-->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control" id="inputLastName" type="text" name="writer">
                                    <label for="inputLastName">Writer</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="text" type="text" name="content">
                            <label for="inputEmail">Contents</label>
                        </div>

                        <div class="mt-4 mb-0">
                            <div class="d-grid"><button type="submit">Register</button></div>
                        </div>
                    </form>
